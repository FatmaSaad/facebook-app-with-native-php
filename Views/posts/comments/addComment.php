		...
		<div style="justify-content: center " class="container">
			...
			<div style="justify-content: center " class="row">
				...
				<div style="justify-content: center " class="col-md-8">
					...
					if ($connect) {
						$comments = mysqli_query($connect, "select * from comments where post_id='{$_GET['id']}'");
						//var_dump($comments);
								...
								<form action="../../../Controllers/PostsController.php" method="post" enctype="multipart/form-data" method="post">
									...
									<div class="card my-4">
										...
										<div class="container-login100-form-btn">
											...
											<button type="submit" value="send" name="comment" class="btn btn-primary btn-block btn-rounded z-depth-1">
												Add Comment &rarr;
											</button>
										</div>
									</div>
